...
# staging tables reflect the structure of the raw JSON files on S3 bucket
...
# Below tables reflect the STAR schema on the target Redshift PostgreSQL database
